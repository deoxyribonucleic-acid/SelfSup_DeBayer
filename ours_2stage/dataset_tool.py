...
input_dir = "/home/ethan/Code/SelfSup_DeBayer/data/train/ILSVRC2012_img_val/"
save_dir = "/home/ethan/Code/SelfSup_DeBayer//data/train/Imagenet_val/"
...
Parallel(n_jobs=16)(delayed(pipline)(idx, img_path) for idx, img_path in enumerate(filtered))
