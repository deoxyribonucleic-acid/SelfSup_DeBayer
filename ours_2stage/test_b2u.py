...
<<<<<<<< HEAD:ours/test_b2u.py
# Ours
parser.add_argument("--noisetype", type=str, default="gauss25", choices=['gauss25', 'gauss5_50', 'poisson30', 'poisson5_50', 'bayer_grbg'])
...
parser.add_argument('--checkpoint', type=str, default='./saved_models/p30_112f20_beta19.1.pth')
>>>>>>>> ad48ead (Add initial code for new_arch):experiment_scripts/test_b2u.py
parser.add_argument('--test_dirs', type=str, default='./data/validation')
parser.add_argument('--save_test_path', type=str, default='./test')
parser.add_argument('--log_name', type=str, default='p30_112f20_beta19.1')
...
========
parser.add_argument("--beta", type=float, default=19.1)
>>>>>>>> ad48ead (Add initial code for new_arch):experiment_scripts/test_b2u.py
...
class AugmentNoise(object):
    def __init__(self, style):
        ...
        # Ours
        elif style.startswith('bayer'):
            self.style = "bayer_grbg"
    ...
    def add_train_noise(self, x):
        ...
        if self.style == "gauss_fix":
            ...
            return noised
        # Ours
        elif self.style == "bayer_grbg":
            bayer = pp.bayer_filter_tensor(x)
            return pp.interp_tensor(bayer)
...
for valid_name, valid_images in valid_dict.items():
    ...
    for i in range(repeat_times):
        for idx, im in enumerate(valid_images):
            ...
            noisy_im = pp.interp_ndarray(pp.bayer_filter_ndarray(im))
